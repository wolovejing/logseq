...
- 遍历二叉树和线索二叉树
	...
	- 先序遍历算法的实现
		- 下列树的先序遍历序列是什么 ![Replaced by Image Uploader](http://pic.1352.love/2022/10/image_1665536845040_0.png){:height 34, :width 207} ?
	...
	- code 静态创建下面所示二叉树 ![Replaced by Image Uploader](http://pic.1352.love/2022/10/image_1665731510761_0.png){:height 34, :width 207} ?
	  collapsed:: true
		- py
